package edu.uci.ics.tingcl2.frontend;

import com.fasterxml.jackson.databind.ObjectMapper;
import com.fasterxml.jackson.dataformat.yaml.YAMLFactory;
import edu.uci.ics.tingcl2.frontend.configs.Configs;
import edu.uci.ics.tingcl2.frontend.logger.ServiceLogger;
import edu.uci.ics.tingcl2.frontend.models.ConfigsModel;
...
public class FrontEnd {
    ...
    private void initHTTPServer() {
        ...
        try {
            ...
            ResourceConfig rc = new ResourceConfig().packages("edu.uci.ics.tingcl2.frontend.src.main.resources");

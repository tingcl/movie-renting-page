package edu.uci.ics.tingcl2.frontend.logger;

import edu.uci.ics.tingcl2.frontend.logger.ServiceFormatter;

import java.io.File;
import java.io.IOException;
import java.util.logging.*;

import static edu.uci.ics.tingcl2.frontend.FrontEnd.ANSI_GREEN;

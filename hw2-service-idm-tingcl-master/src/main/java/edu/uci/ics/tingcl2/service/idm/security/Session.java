package edu.uci.ics.tingcl2.service.idm.security;
...
public class Session {
    ...
    public static final long SESSION_TIMEOUT = Long.parseLong(configs.getTimeout()); // 10-minute timeout
    public static final long TOKEN_EXPR = Long.parseLong(configs.getExpiration()); // 30-minute expiration

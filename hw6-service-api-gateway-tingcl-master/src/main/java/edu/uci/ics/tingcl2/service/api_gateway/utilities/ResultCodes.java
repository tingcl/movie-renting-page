...
public class ResultCodes {
    ...
    // Request header codes
    public static final int HEADER_EMAIL_NOT_FOUND = -16;
    public static final int HEADER_SESSION_NOT_FOUND = -17;


    // api/idm/user/register
    public static final int REGISTRATION_SUCCESSFUL = 110;
    ...
    public static final int[] resultCodes = {
            ...
            USER_NOT_FOUND, SESSION_NOT_FOUND, EMAIL_ALREADY_IN_USE, REGISTRATION_SUCCESSFUL, LOGIN_SUCCESSFUL,
            ...
            CANNOT_ELEVATE_USER_TO_ROOT, HEADER_EMAIL_NOT_FOUND, HEADER_SESSION_NOT_FOUND
    };
    ...
    public static String setMessage(int code) {
        switch (code) {
            ...
            case HEADER_EMAIL_NOT_FOUND:
                return "Email not provided in request header.";
            case HEADER_SESSION_NOT_FOUND:
